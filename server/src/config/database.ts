...
export const connectDB = async () => {
  try {
    ...
    const options = {
      serverSelectionTimeoutMS: 5000, // 5s timeout - fail fast for serverless
      ...
      retryWrites: true,
      retryReads: true,
      // Additional options for faster connection
      directConnection: false, // Use connection string's connection mode
